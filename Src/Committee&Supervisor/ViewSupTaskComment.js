...
const ViewsupTaskComments = ({route}) => {
  ...
  const fetchComments = async groupid => {
    try {
      const response = await fetch(
        `${API_URL}/Remarks/GetSupervisorTaskRemarks?groupid=${groupid}`,
        {
          method: 'GET',
          headers: {
            ...
            <View
              ...
              <View style={styles.itemContent}>
                <View style={styles.column}>
                  ...
                  {/* <Text style={{color: 'black'}}>
                    {item.is_from_supervisor ? '' : 'Commented by Committee'}
                  </Text> */}
                  {/* <Text style={{color: 'black'}}>
...
export default ViewsupTaskComments;
